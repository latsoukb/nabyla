...
<head>
  ...
  <title>Paiement Wave - Démo</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .amount { font-size: 32px; font-weight: bold; color: #1DC8FF; margin: 16px 0; }
    ...
    .btn-pay { background: #1DC8FF; color: white; }
...
<body>
  <div class="card">
    ...
    <a href="${baseUrl}/commande/succes?orderId=${orderId}" class="btn btn-pay"
       onclick="fetch('${baseUrl}/api/payment/wave/demo/confirm?orderId=${orderId}')">
